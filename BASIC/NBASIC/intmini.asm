...
serialInt:      PUSH     AF
                ...
                IN       A,($00)
                AND      $40             ; Check if interupt due to read buffer full
...
conout1:        IN       A,($00)         ; Status byte       
                BIT      7,A             ; Set Zero flag if still transmitting character       
